        ...
        <table className="min-w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="border border-gray-300 py-2 px-4 sm:px-6 md:px-8">Comfirm</th>
          ...
          <tbody>
            {orders?.map(order => (
              <tr key={order._id} className='text-center'>
                ...
                <td className='border border-gray-300 py-2 px-4 sm:px-6 md:px-8'>{order.isComfirm ? "Yes" : "No"}</td>
